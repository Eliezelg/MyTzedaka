...
export declare class MultiTenantStripeService {
    ...
    confirmPayment(tenantId: string, paymentIntentId: string, paymentMethodId?: string): Promise<Stripe.PaymentIntent>;
    retrievePaymentIntent(tenantId: string, paymentIntentId: string): Promise<Stripe.Response<Stripe.PaymentIntent>>;
    getPaymentIntent(tenantId: string, paymentIntentId: string): Promise<Stripe.PaymentIntent>;
    ...
    verifyWebhookSignature(payload: Buffer, signature: string): Promise<Stripe.Event>;
    updateConnectAccountStatus(stripeAccountId: string, account: Stripe.Account): Promise<void>;
}
